    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DotrA_Lab.ORM.Context.DotrADbContext>
    {
        ...
        protected override void Seed(DotrA_Lab.ORM.Context.DotrADbContext context)
        {
            ...
            context.Category.AddOrUpdate(
                new Category() { CategoryID = 1, CategoryName = "生活", Categorydescript = "生活小物用品" },
                new Category() { CategoryID = 2, CategoryName = "休閒食品", Categorydescript = "餅乾.糖果.肉乾等種類" },
                new Category() { CategoryID = 3, CategoryName = "授權商品", Categorydescript = "迪士尼授權" },
                new Category() { CategoryID = 4, CategoryName = "親子", Categorydescript = "幼稚園至國小用品，非嬰兒用品" },
                new Category() { CategoryID = 5, CategoryName = "3C配件", Categorydescript = "手機.平板週邊商品" }
                );
            context.SaveChanges();

            context.Supplier.AddOrUpdate(
                new Supplier() { SupplierID = 1, CompanyName = "添糖有限公司", CompanyAddress = "新北市板橋區四川路二段47巷11號", CampanyPhone = @"02-3567-8712" },
                new Supplier() { SupplierID = 2, CompanyName = "朵雀艾蜜有限公司", CompanyAddress = "新北市中和區景平路123號", CampanyPhone = @"02-1345-6791" },
                new Supplier() { SupplierID = 3, CompanyName = "昌達企業有限公司", CompanyAddress = "臺北市大同區重慶北路1段27巷8號", CampanyPhone = @"02-3345-6773" },
                new Supplier() { SupplierID = 4, CompanyName = "騎士穀堡有限公司", CompanyAddress = "新北市中和區中正路123號", CampanyPhone = @"02-2678-0981" },
                new Supplier() { SupplierID = 5, CompanyName = "金百有限公司", CompanyAddress = "高雄市三民區堯山街12號", CampanyPhone = @"07-2456-1789" },
                new Supplier() { SupplierID = 6, CompanyName = "佳美能股份有限公司", CompanyAddress = "台中市大雅區民族路156號", CampanyPhone = @"04-2568-0917" }
                );
            context.SaveChanges();
